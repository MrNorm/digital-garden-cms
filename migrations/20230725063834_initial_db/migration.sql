...
-- AddForeignKey
ALTER TABLE "_Cutting_images" ADD CONSTRAINT "_Cutting_images_A_fkey" FOREIGN KEY ("A") REFERENCES "Cutting"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "_Cutting_images" ADD CONSTRAINT "_Cutting_images_B_fkey" FOREIGN KEY ("B") REFERENCES "Image"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "_Cutting_tags" ADD CONSTRAINT "_Cutting_tags_A_fkey" FOREIGN KEY ("A") REFERENCES "Cutting"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "_Cutting_tags" ADD CONSTRAINT "_Cutting_tags_B_fkey" FOREIGN KEY ("B") REFERENCES "Tag"("id") ON DELETE CASCADE ON UPDATE CASCADE;
